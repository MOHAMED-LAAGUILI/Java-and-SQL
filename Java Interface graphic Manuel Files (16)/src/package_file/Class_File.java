...
public class Class_File extends javax.swing.JFrame {
    ...
    void Ajouter() throws IOException{
        ...
        fw = new FileOutputStream(f1,true);
        fw.write(tb);
        fw.close(); 
    }
    ...
    private void JOptionPane(Class_File aThis, String il_faut_remplir_la_zone_de_text, String zone_Vide, int ERROR_MESSAGE) {
